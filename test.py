...
def main():
    ...
    if n_flag_ow:
        print('Overwriting noise flags. Using n_noisy_samples=%s, add_shot=%s, add_sys=%s,add_cosvar=%s, sigma_sys=%s' %(FLAGS.n_noisy_samples, str(FLAGS.add_shot),str(FLAGS.add_sys),str(FLAGS.add_cosvar), FLAGS.sigma_sys))
